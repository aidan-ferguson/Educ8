...
urlpatterns = [
    ...
    path('my_courses/<slug:course_name_slug>/add_or_edit_flashcard',
         views.add_or_edit_flashcard, name='forms/add_or_edit_flashcard'),
    ...
    path('studentRegister/', views.studentRegister, name='forms/register'),
    path('teacherRegister/', views.teacherRegister, name='forms/register'),
